...
def load_predictor(model_dir,
    ...
    if run_mode in precision_map.keys():
        config.enable_tensorrt_engine(
            workspace_size=15 * 1024 * 1024 * 1024,
            max_batch_size=8,
...
'''
python my_infer.py --model_dir=models/big_particle_trt --image_dir=test_data/tmp_test \
  --device=gpu --run_mode=trt_fp16 --output_dir=tmp2
'''
